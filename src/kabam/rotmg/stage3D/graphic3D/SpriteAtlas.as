package kabam.rotmg.stage3D.graphic3D
{
   ...
   public class SpriteAtlas
   {
      ...
      // Enabled: CPU mode re-uploads whole 16 MB pages on every frame that sees a new sprite,
      // which stalls the pipeline for as long as you keep roaming into new content. RTT blits
      // only the new sprites (upload cost proportional to what appeared). Orientation with
      // FLIP_Y=false is identity: the working post-filter path proves RTT maps NDC y=+1 to v=0.
      public static const USE_RTT:Boolean = true;
